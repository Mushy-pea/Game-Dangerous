...
last_dir :: Int, dir_list :: [Int], node_num :: Int, end_node :: Int, head_index :: Int, target_u' :: Int, target_v' :: Int, target_w' :: Int, speed :: Float, avoid_dist :: Int, attack_mode :: Bool, final_appr :: Bool, fire_prob :: Int} deriving (Eq, Show)
