...
choose_game_text = [1, 3, 34, 41, 41, 45, 31, 63, 49, 34, 35, 29, 34, 63, 33, 27, 39, 31, 63, 46, 41, 63, 38, 41, 27, 30]; game_state_text = [7, 27, 39, 31, 63, 45, 46, 27, 46, 31, 63]; game_time_text = [7, 27, 39, 31, 63, 46, 35, 39, 31, 69, 63]
