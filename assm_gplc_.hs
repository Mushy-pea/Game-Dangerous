...
assm_gplc2 16 (x0:x1:x2:x3:x4:x5:x6:xs) sym ind = (read x0) : (assm_gplc3 0 x1 sym ind) : (assm_gplc3 0 x2 sym ind) : (assm_gplc3 0 x3 sym ind) : (assm_gplc3 0 x4 sym ind) : (assm_gplc3 0 x5 sym ind) : [assm_gplc3 0 x6 sym ind]
...
assm_gplc2 18 (x0:x1:x2:x3:xs) sym ind = (assm_gplc3 0 x0 sym ind) : (assm_gplc3 0 x1 sym ind) : (assm_gplc3 0 x2 sym ind) : [assm_gplc3 0 x3 sym ind]
...
assm_gplc1 (x:xs) sym ind = 
  ...
  else if x == "chg_save_grid" then 16 : (assm_gplc2 16 (take 7 xs) sym ind) ++ assm_gplc1 (drop 7 xs) sym ind
  else if x == "project_init" then 17 : (assm_gplc2 17 (take 9 xs) sym ind) ++ assm_gplc1 (drop 9 xs) sym ind
  else if x == "project_update" then 18 : (assm_gplc2 18 (take 4 xs) sym ind) ++ assm_gplc1 (drop 4 xs) sym ind
